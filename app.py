...
LANG_OPTION_LABELS = {
    "中文": {LANG_ZH: "中文", LANG_EN: "Chinese"},
    "英文": {LANG_ZH: "英文", LANG_EN: "English"},
}
...
def _language_option_label(value: str, lang: str) -> str:
    """Return a language-option label in the currently active interface language."""

    return LANG_OPTION_LABELS.get(value, {}).get(lang, value)
    ...
    with language_col:
        with st.popover(_t(lang_for_labels, "语言", "Language"), use_container_width=True):
            lang_label = st.radio(
                ...
                key="language_choice",
                format_func=lambda value: _language_option_label(value, lang_for_labels),
